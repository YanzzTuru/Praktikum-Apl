    ...
    while (attempts < maxAttempts) {
        ...
        if (username == usernamePenjual && password == passwordPenjual) {
            ...
            if (attempts == maxAttempts) {
                cout << "Login gagal Anda telah mencoba sebanyak 3 kali. Program berhenti.\n";
                return false; 
            }
        }
    }
...
int menuPenjual() {
    ...
    do {
        ...
        if (pilihan == 1) {
            ...
            while (isEmptyOrWhitespace(sepatu[jumlahBarang])) {
                cout << "Nama sepatu tidak boleh kosong atau hanya spasi. Silakan coba lagi: ";
                getline(cin, sepatu[jumlahBarang]);
            }
            ...
            while (harga[jumlahBarang] < 0) {
                cout << "Harga tidak boleh negatif. Silakan masukkan harga yang valid: ";
                cin >> harga[jumlahBarang];
            }
            ...
            while (stok[jumlahBarang] < 0) {
                cout << "Stok tidak boleh negatif. Silakan masukkan stok yang valid: ";
                cin >> stok[jumlahBarang];
            }
            cin.ignore();
            jumlahBarang++;
